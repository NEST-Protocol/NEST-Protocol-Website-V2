import {
  ...
  PopoverTrigger,
  Stack,
  Text, Link as ChakraLink, HStack,
...
export default function Navigation() {
  ...
  return (
    <Stack px={'45px'} minH={'72px'} h={'72px'} direction={"row"} justifyContent={"space-between"}
           align={"center"} bg={isScrolled ? 'white' : 'transparent'} position={'sticky'} top={0} zIndex={'banner'}>
