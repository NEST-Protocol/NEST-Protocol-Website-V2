  ...
  const pcPage = (
    <Stack bgImage={'/image/Oracle/bg.jpg'} bgPosition={"center"} bgSize={'cover'}>
      ...
      <Stack textAlign={"center"} align={"center"} spacing={'30px'} py={'120px'}>
        ...
        <Text fontSize={'18px'} fontWeight={'400'} color={'rgba(3, 3, 8, 0.6)'}>Unlike the price generated by Price Feed in the market, <br/>
      ...
      <Stack align={"center"} pt={'44px'} pb={'138px'}>
        ...
        <Stack pt={'68px'}>
          <Button as={Link} href={'/docs/root/Technical-Reference-NEST-Oracle'} variant={'outline'} border={'2px solid'}
                  borderColor={'#EAAA00'} color={'#EAAA00'}>
            More
          </Button>
        </Stack>
