            ...
            <HStack align={"center"} justify={"center"}>
              <Stack>
                <HStack spacing={'24px'} mt={'44px'} justifyContent={"center"}>
                  <Stack p={'20px'} spacing={'20px'} bg={'rgba(255, 255, 255, 0.80)'} borderRadius={'12px'} align={"center"}>
                    <Stack w={'80px'} h={'80px'}>
                  ...
                  <Stack p={'20px'} spacing={'20px'} bg={'rgba(255, 255, 255, 0.80)'} borderRadius={'12px'} align={"center"}>
                    ...
                    <Text fontSize={'14px'} lineHeight={'20px'} fontWeight={'700'} color={'#030308'}>NEST2.0 (ETH): 0xcd6926193308d3B371FdD6A6219067E550000000</Text>
                  </Stack>
                </HStack>
                <Stack mt={'40px'}>
                  {
                      ...
                      <HStack justifyContent={"center"} w={'full'}>
                        {
                          address ? (
                            sent ? (
                              pass ? (
                                received ? (
                                  <HStack borderRadius={'12px'} bg={'#CFF5D0'} border={'1px solid #2ECD3C'} px={'40px'}
                                    ...
                                    <Stack spacing={'8px'}>
                                      {/*TODO*/}
                                      <Text fontSize={'20px'} lineHeight={'28px'} fontWeight={700}>Successfully claimed XXX NEST2.0</Text>
                                    </Stack>
                                  </HStack>
                                ) : (
                                  <HStack borderRadius={'12px'} bg={'#CFF5D0'} border={'1px solid #2ECD3C'} px={'40px'}
                                    ...
                                    <Stack spacing={'8px'} align={"start"}>
                                      {/*TODO*/}
                                      <Text fontSize={'20px'} lineHeight={'28px'} fontWeight={700}>XXX NEST 2.0</Text>
                                      <Text fontSize={'16px'} lineHeight={'22px'} fontWeight={400} color={'rgba(3, 3, 8, 0.60)'}>Available for Claim</Text>
                                    </Stack>
                                    <Spacer/>
                                ...
                                <HStack px={'40px'} py={'24px'} bg={'rgba(234, 170, 0, 0.40)'} border={'1px solid #EAAA00'} w={'full'}
                                  ...
                                  <Stack align={"start"}>
                                    ...
                                    <Text fontSize={'16px'} fontWeight={400} maxW={'500px'} textAlign={"start"} color={'rgba(3, 3, 8, 0.60)'}
                                          lineHeight={'22px'}>Application will be reviewed within 1 business day and your token can be replaced upon approval.</Text>
                                  </Stack>
                                  <Spacer/>
                                  <Button px={'24px'}>
                                    <HStack spacing={'12px'}>
                              ...
                              <HStack bg={'rgba(255,255,255,0.8)'} px={'40px'} py={'24px'} borderRadius={'12px'} w={'full'} gap={'24px'}>
                                <Stack h={'40px'} w={'40px'}>
                                  <svg width="41" height="40" viewBox="0 0 41 40" fill="none"
                                       xmlns="http://www.w3.org/2000/svg">
                                    <path fillRule="evenodd" clipRule="evenodd"
