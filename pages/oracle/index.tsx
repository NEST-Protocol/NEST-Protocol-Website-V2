  ...
  const pcPage = (
    <Stack bgImage={'/image/Oracle/bg.jpg'} bgPosition={"center"} bgSize={'cover'}>
      ...
      <Stack textAlign={"center"} align={"center"} spacing={'30px'} py={'120px'}>
        ...
        <Text fontSize={'18px'} fontWeight={'400'}>Unlike the price generated by Price Feed in the market, <br/>
  ...
  const mobilePage = (
    <Stack bgImage={'/image/Oracle/bg.jpg'} bgPosition={"center"} bgSize={'cover'}>
      ...
      <Stack textAlign={"center"} align={"center"} py={'90px'}>
        ...
        <Text fontSize={'12.5px'} fontWeight={'400'}>Unlike the price generated by Price<br/>
